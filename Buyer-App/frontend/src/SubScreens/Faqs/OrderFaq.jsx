...
function OrderFaq() {
  ...
  const accordianArray = [
    {
      ...
      content:
        "Currently the buyer app does not offer any protection from fraud since the app is built on the recently launched ONDC protocol and its still evolving. However, you can still get support for orders via the support/IGM (Issues and Grievance management) section on the buyer app.",
      content2: "",
  ...
  return (
    <>
      ...
      <div className="store-Faq-ContentMain_Header">Order</div>
