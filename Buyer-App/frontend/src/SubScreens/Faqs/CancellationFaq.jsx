...
function CancellationFaq() {
  ...
  const accordianArray = [
    {
      title: "how to know if my order is returnable and/or cancellable?",
      content:
        "All the products being displayed in the search results will have a tag showing whether the product/order can be cancelled or returned",
      content2: "",
  ...
  return (
    <>
      ...
      <div className="store-Faq-ContentMain_Header"> Cancellation and Returns</div>
